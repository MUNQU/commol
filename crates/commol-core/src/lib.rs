...
pub use types::{
    ...
    Parameter, Population, Rule, RuleValue, Stratification, StratificationCondition,
    StratificationFraction, StratificationFractions, StratifiedRate, Transition, VariablePrefixes,
};
